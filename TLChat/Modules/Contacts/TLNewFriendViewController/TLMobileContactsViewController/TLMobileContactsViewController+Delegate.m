//
//  TLMobileContactsViewController+Delegate.m
//  TLChat
//
...
@implementation TLMobileContactsViewController (Delegate)

- (void)registerCellClass
{
    [self.tableView registerClass:[TLContactsHeaderView class] forHeaderFooterViewReuseIdentifier:@"TLContactsHeaderView"];
...
{
    TLUserGroup *group = [self.data objectAtIndex:section];
    TLContactsHeaderView *view = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"TLContactsHeaderView"];
