...
- (void)initUserData
{
    ...
    if ([date isSameDay:[NSDate date]]) {
        if (sponsorStatus.integerValue == 3) {
            [TLAlertView showWithTitle:nil message:@"如果此份源码对您有足够大帮助，您可以小额赞助我，以激励我继续维护，做得更好。" cancelButtonTitle:@"不了" otherButtonTitles:@[@"小额赞助"] actionHandler:^(NSInteger buttonIndex) {
                if (buttonIndex == 1) {
