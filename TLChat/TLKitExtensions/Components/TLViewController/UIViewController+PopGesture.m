...
- (id)__tt_initWithRootViewController:(UIViewController *)rootViewController
{
    ...
    [self tt_setAssociatedObject:self.interactivePopGestureRecognizer.delegate forKey:@"systemInteractivePopGestureRecognizerDelegate" association:TLAssociationStrong];
    return self;
}

- (id)systemInteractivePopGestureRecognizerDelegate
{
    return [self tt_associatedObjectForKey:@"systemInteractivePopGestureRecognizerDelegate"];
}
...
{
    [self tt_setAssociatedObject:@(disablePopGesture) forKey:@"__tt_disablePopGesture" association:TLAssociationAssign];
...
{
    return [[self tt_associatedObjectForKey:@"__tt_disablePopGesture"] boolValue];
}
